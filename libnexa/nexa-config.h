/* src/config/nexa-config.h.  Generated from nexa-config.h.in by configure.  */
/* src/config/nexa-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef NEXA_CONFIG_H

#define NEXA_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Bitcoin XT and Bitcoin Unlimited developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Bitcoin XT and Bitcoin Unlimited"
...
/* Define to 1 to enable GPERF */
/* #undef ENABLE_GPERF */

/* Define to 1 to enable profiling */
/* #undef ENABLE_GPROF */

/* Define to 1 to enable java binding in cashlib */
/* #undef ENABLE_JAVACASHLIB */

/* Define to 1 to enable mutex tracing */
/* #undef ENABLE_MUTRACE */
...
#define PACKAGE_BUGREPORT "https://gitlab.com/nexa/nexa/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Nexa"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Nexa 1.0.2.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "nexa"
